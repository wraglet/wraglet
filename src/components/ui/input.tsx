        ...
        <div className="relative flex items-center">
          <input
            ...
            className={cn(
              ...
              'h-8 rounded border border-solid border-slate-200 px-4 py-1.5 pr-10 text-xs hover:border-slate-300 focus:border-indigo-300 focus:outline-none active:border-indigo-300',

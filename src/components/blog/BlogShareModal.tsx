  ...
  const visibilityOptions = [
    {
      ...
      label: 'Public',
      description: 'Anyone can see this shared blog'
    },
    {
    ...
    },
    {
      ...
      icon: FaLock,
      label: 'Only me',
      description: 'Only you can see this shared blog'
    }
  ]
  ...
  const handleShareToFeed = async () => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        toast.success('Blog shared to your feed!')

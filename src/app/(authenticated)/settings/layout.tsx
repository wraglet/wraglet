...
const SettingsLayout = ({ children }: SettingsLayoutProps) => {
  ...
  return (
    <div className="mx-auto mt-12 flex w-full max-w-5xl items-start gap-x-[10px] xl:w-[1100px]">
      {/* Sidebar */}
      <aside className="w-64 rounded-lg bg-white p-6 shadow-md">
      ...
      {/* Main Content */}
      <section className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-start rounded-lg bg-white p-8 shadow-md">
        {children}
      </section>
    </div>
  )
